...
class EditCurrency extends Component {
    ...
    async componentDidMount() {
        ...
        // Load Currency
        this.setState({isLoading: true});
        this._isMounted && await this.props.makeRequest(request.Currencies.get, id, {message: MESSAGES.LOGGING}).then(
            (res) => {
                if (res.data) {
                    this.setState({
                        name: res.data.name,
    ...
    handleSubmit(event, errors, values) {
        ...
        this.setState({isLoading: true});
        this.props.makeRequest(request.Currencies.update, data, {message: MESSAGES.LOGGING}).then(
            (res) => {
                    ...
                    <Row>
                        <Col md="12">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    <CardTitle>Edit Currency Form</CardTitle>
